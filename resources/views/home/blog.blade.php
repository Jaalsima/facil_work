        ...
        <div class="flex w-3/4 mx-auto my-6">
            <div class="">
                <div class="pl-4 pr-12 py-4">
                    ...
                    <a href="#"
                        class="w-full mt-10 h-auto flex flex-col items-center shadow-lg shadow-gray-500 bg-white border border-gray-200 rounded-lg md:flex-row hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
