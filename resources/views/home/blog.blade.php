<x-guest-layout>
    <div>
        ...
        <div class="m-20">
            ...
            <div class="text-6xl text-bold text-gray-500">
            ...
            <div>
                ...
                <aside class="w-48 float-right border-l-2 p-4 text-xl">
                ...
                <a href="#"
                    ...
                    <img class="object-cover w-96 rounded-t-lg h-auto md:h-auto md:rounded-none md:rounded-r-lg"
