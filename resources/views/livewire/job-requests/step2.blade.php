<div>
    <h3 class="mb-24 font-mono text-4xl">Ayúdanos a aclarar tu necesidad</h3>
    <p class="mb-24 font-sans text-3xl">Selecciona una locación</p>
    <x-input class="mb-24 text-2xl bg-gray-700 h-28 shadow-black" type="text" wire:model="location" />
    {{-- <div class="flex justify-around mb-12">
        <svg xmlns="http://www.w3.org/2000/svg" height="1em" fill="#eeeeee"
